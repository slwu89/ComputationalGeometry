...
// }
//
// void insertSite(Apo_graph* ag, double x, double y, double weight){
//   Point p(x, y);
//   Weight w(weight);
//   Site s(p, w);
//   ag->insert(s);
// }
//
// // unbounded weighted Voronoi diagram
// Apo_graph* generateApolloniusUnbounded(const Rcpp::NumericVector &siteX, const Rcpp::NumericVector &siteY, const Rcpp::NumericVector &weight){
//   Apo_graph* ag = new Apo_graph();
//
//   int nSite = siteX.size();
//
//   // insert sites
//   for(int i=0; i<nSite; i++){
//     double x = siteX.at(i);
//     double y = siteY.at(i);
//     double weight = weight.at(i);
//     insertSite(ag, x, y, weight);
//   }
//
//   return(ag);
// }
...
// Apo_graph* generateApolloniusBounded(
//   const Rcpp::NumericVector &siteX,
//   const Rcpp::NumericVector &siteY,
...
//   {
//
//   Apo_graph* ApolloniusGraph;
//   Rcpp::CharacterVector intersectionsPath;
//
//
//   // generateApo_graphCustom
//
